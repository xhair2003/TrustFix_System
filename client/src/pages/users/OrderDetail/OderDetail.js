...
// import { confirmRequest, resetError, resetSuccess } from '../../../store/actions/userActions';
...
//     // Redux state
//     const { loading, successConfirmRequest, errorConfirmRequest } = useSelector(state => state.user);
...
//                 <button className="complain-btn" onClick={handleComplain} disabled={loading}>
//                     Khiếu nại
//                 </button>
//                 {isCompleted ? (
//                     <button className="rate-btn" onClick={handleOpenRatingModal} disabled={loading}>
//                         Đánh giá thợ
//                     </button>
//                 ) : (
//                     <button className="confirm-btn" onClick={handleConfirmCompletion} disabled={loading || request.status !== "Proceed with repair"}>
            ...
            <div className="action-buttons">
                ...
                {isCompleted ? (
                    ...
                    <button
                        ...
                        disabled={loading || request.status !== "Proceed with repair"}
                    >
                        Xác nhận thợ đã sửa xong
                    </button>
                )}
