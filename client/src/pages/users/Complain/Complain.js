...
//                             <div className="form-group">
//                                 <label>Tên thợ:</label>
//                                 <input type="text" value={repairman.fullName} readOnly className="form-input readonly" />
//                             </div>
//                             <div className="form-group">
//                                 <label>Ngày tạo đơn:</label>
//                                 <input type="text" value={request.createdAt} readOnly className="form-input readonly" />
//                             </div>
//                         </div>
//                     </div>
                    ...
                    <div>
                        ...
                        <div className="booking-info-section">
                            ...
                            <div className="form-group">
                                ...
                                <input
                                    type="text"
                                    value={hasState ? repairman.fullName : "Không có dữ liệu"}
                                    readOnly
                                    className="form-input readonly"
                                />
                            </div>
                            <div className="form-group">
                                ...
                                <input
                                    type="text"
                                    value={hasState ? request.createdAt : "Không có dữ liệu"}
                                    readOnly
                                    className="form-input readonly"
                                />
                            </div>
